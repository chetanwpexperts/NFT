...
(gj.widget = function () {
    ...
    (gj.datepicker.config = {
        ...
        glyphicons: {
            icons: { rightIcon: '<span class="fa fa-calendar"></span>', previousMonth: '<span class="glyphicon glyphicon-chevron-left"></span>', nextMonth: '<span class="glyphicon glyphicon-chevron-right"></span>' },
        },
    }),
