			...
			<div class="row">
				...
				<div class="col-lg-6 col-sm-6">
					<div class="signin_form">
						...
						<form action="{{ route('auth.checkotp') }}" method="POST" id="verifyotp">
						  @csrf
						  ...
						  <button type="submit" class="btn btn-default btn_sign verifyotp">Verify & Continue</button><p id="countdown" class="resend-text">resend OTP in 45 sec</p>
						</form>
