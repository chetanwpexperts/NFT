							...
							<tbody>
                                ...
                                foreach($nfts as $nft)
                                {
                                    ...
                                    <?php 
                                        ...
                                        <td><a href="{{route('nft.edit', [$nft->nftid])}}" style="color:#EECB1C;font-weight:600;font-size: large;text-decoration:underline;"><i class="fas fa-sticky-note"></i> Publish</a></td>
                                    </tr>
                                    @php
                                $count++;
                                }
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="offer-details">
                                        ...
                                        <p class="sold_bg_you"><a href="{{route('nft.edit', [$nft->nftid])}}" style="color:#EECB1C;font-weight:600;font-size: large;text-decoration:underline;"><i class="fas fa-sticky-note"></i> Publish</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
